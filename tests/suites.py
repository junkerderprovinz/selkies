...
SUITES: list = [
    ...
    {"path": "e2e/test_ack_heartbeat.py", "tier": "e2e", "timeout": 900,
     "selectors": ["chromium", "firefox", "webkit"]},
    ...
    {"path": "e2e/test_webcam.py", "tier": "e2e", "timeout": 900,
     "selectors": ["websockets", "webrtc", "av1", "locked", "nowebcodecs", "rotation", "reformat", "detail", "encoderpref"]},
    {"path": "e2e/test_microphone.py", "tier": "e2e", "timeout": 600,
     "selectors": ["websockets", "webrtc"]},
    {"path": "e2e/test_media_on_start.py", "tier": "e2e", "timeout": 900,
     "selectors": ["websockets", "webrtc", "websockets-wl", "webrtc-wl"]},
    ...
    {"path": "e2e/test_ice_topologies.py", "tier": "e2e", "timeout": 1200,
     "selectors": ["portrange", "udpmux", "tcpmux", "icelite", "combined", "combined-wl"]},
